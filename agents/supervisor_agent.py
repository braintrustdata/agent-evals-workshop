...
SUPERVISOR_TOOLS = [
    {
        ...
        "function": {
            "name": "ask_sql_agent",
            "description": "Ask the SQL agent to query the eCommerce database. Provide a clear natural language question about the data.",
            "parameters": {
                "type": "object",
                "properties": {
                    "question": {
...
class SupervisorAgent(BaseAgent):
    ...
    @braintrust.traced(name="supervisor_agent_run")
